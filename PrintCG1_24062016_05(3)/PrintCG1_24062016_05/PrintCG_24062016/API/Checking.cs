...
using PrintCG_24062016.API.Enums;
...
namespace PrintCG_24062016.API
{
    public class Checkpoint
    {
        ...
        public Checkpoint(JObject checkpointJSON)
        {
            ...
            //frm.addData(this.city, this.createdAt.ToString(), this.countryName, this.message, this.countryISO3.ToString(), this.tag, this.checkpointTime, this.state, this.zip);
        }
