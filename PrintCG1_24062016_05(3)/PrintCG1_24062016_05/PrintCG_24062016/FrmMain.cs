...
namespace PrintCG_24062016
{
    public partial class FrmMain : Form
    {
        ...
        private void traHồiBáoTừExcelToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void bảngXuấtNhậpKhoToolStripMenuItem_Click(object sender, EventArgs e)
        {
        
        }

        private void bảngNhậpToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void bảngXuấtToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void inDanhSáchPhiếuGửiToolStripMenuItem_Click(object sender, EventArgs e)
        {

        }

        private void nhậpPlanToolStripMenuItem_Click(object sender, EventArgs e)
        {
