...
namespace PrintCG_24062016
{
    public partial class CG1_LE : Form
    {
        ...
        private void loadsophieu()
        {
            ...
            if (txtsophieu.Text != "")
            {
                string _nam = txtsophieu.Text.Substring(0, 2);
                string _thang = txtsophieu.Text.Substring(2, 2);
                string _ngay = txtsophieu.Text.Substring(4, 2);
               
                if (_nam == nam && _thang == thang && _ngay == ngay)
                {
                    txtsophieu.Text = txtsophieu.Text;
                }
                else
                {
                    txtsophieu.Text =  nam + thang + ngay + "0001";
                }
            }
            else
            {
